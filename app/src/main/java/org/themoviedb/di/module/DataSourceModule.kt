...
class DataSourceModule {
    ...
    @Provides
    @Singleton
    fun provideMovieDataSourceFactory(services: TheMovieDbServices,
                                      errorResponseHandler: ErrorResponseHandler) = MovieDataSourceFactory(services, errorResponseHandler)

    @Provides
    @Singleton
    fun provideTvShowDataSourceFactory(services: TheMovieDbServices,
